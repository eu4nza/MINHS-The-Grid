        ...
        <div className="text-base p-6 xl:text-lg xl:p-12 w-full bg-white text-black border border-black/5 shadow-2xl rounded-lg">
          <div className="flex flex-col gap-2">
            ...
            <div className="py-6 flex flex-col gap-2">
              ...
              <p>Presents the solution you implemented.</p>

              <p className="font-bold">✅ What to Include:</p>
              <ul className="list-disc list-inside ml-4 space-y-1">
                <li>
                  Detailed description of the intervention (e.g., use of mobile
                  reading apps, peer tutoring)
                </li>
                <li>Implementation timeline</li>
                <li>Materials/tools used</li>
                <li>Instructional strategies</li>
                <li>
                  Why the strategy is expected to help (supported by research or
                  experience)
                </li>
              </ul>
            </div>
