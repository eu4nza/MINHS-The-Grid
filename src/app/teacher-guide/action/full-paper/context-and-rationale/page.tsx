      ...
      <div className="flex flex-col py-24 xl:py-32 relative gap-2 justify-center items-start w-full text-black px-5 xl:px-10">
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>IV. Context and Rationale</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
        ...
        <div className="flex flex-col md:flex-row justify-between items-start xl:items-center w-full gap-y-4 xl:gap-y-0 mb-5">
          ...
          <div className="flex flex-row gap-2 sm:gap-4 w-auto">
            <Link href="/teacher-guide/action/full-paper/acknowledgment">
              <Button
                variant="default"
            ...
            <Link href="/teacher-guide/action/full-paper/action-research-questions">
              <Button
                variant="default"
                className="w-[100px] bg-white hover:bg-black/10 border border-black/5 rounded-lg transition-all duration-300 cursor-pointer"
              >
        ...
        <div className="text-base p-6 xl:text-lg xl:p-12 w-full bg-white text-black border border-black/5 shadow-2xl rounded-lg">
          <div className="flex flex-col gap-2">
            ...
            <div className="py-6 flex flex-col gap-2">
              ...
              <p>Explains the background of the problem and why it matters.</p>

              <p className="font-bold">✅ What to Include:</p>
              <ul className="list-disc list-inside ml-4 space-y-1">
                <li>
                  Description of the school/classroom situation (e.g., in
                  Cavite)
                </li>
                <li>
                  Identified problem (e.g., low reading comprehension,
                  absenteeism)
                </li>
                <li>Supporting data or observations</li>
                <li>
                  Alignment with DepEd priorities (e.g., PPST, BE-LCP, Sulong
                  EduKalidad)
                </li>
                <li>Why this problem requires action research</li>
              </ul>
            </div>
          </div>
        </div>
