        ...
        <div className="text-base p-6 xl:text-lg xl:p-12 w-full bg-white text-black border border-black/5 shadow-2xl rounded-lg">
          <div className="flex flex-col gap-2">
            ...
            <div className="py-6 flex flex-col gap-2">
              ...
              <p>Recognize contributions and support.</p>

              <p className="font-bold">✅ Who to Thank:</p>
              <ul className="list-disc list-inside ml-4 space-y-1">
                <li>School Head</li>
                <li>Research mentor</li>
                <li>Colleagues or co-researchers</li>
                <li>Students and parents (if applicable)</li>
                <li>Funding or institutional support</li>
              </ul>
            </div>
          </div>
        </div>
