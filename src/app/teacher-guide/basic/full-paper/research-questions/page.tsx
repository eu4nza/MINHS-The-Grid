      ...
      <div className="flex flex-col py-24 xl:py-32 relative gap-2 justify-center items-start w-full text-black px-5 xl:px-10">
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>VI. Research Questions</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="py-6 flex flex-col gap-6">
              ...
              <div>
                ...
                <p>
                  Clearly state the specific questions your research aims to
                  answer.
                </p>
              </div>
              ...
              <div>
                ...
                <ul className="list-disc list-inside ml-4 space-y-1">
                  <li>
                    <span className="font-bold">Main question</span> – the
                    general goal of your research.
                  </li>
                  <li>
                    <span className="font-bold">Sub-questions</span> – specific
                    areas of focus.
                  </li>
                  <li>
                    Questions must align with your{" "}
                    <span className="font-bold">objectives</span> and{" "}
