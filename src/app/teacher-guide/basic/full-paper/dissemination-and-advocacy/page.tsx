      ...
      <div className="flex flex-col py-24 xl:py-32 relative gap-2 justify-center items-start w-full text-black px-5 xl:px-10">
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>X. Dissemination and Advocacy</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
        ...
        <div className="flex flex-col md:flex-row justify-between items-start xl:items-center w-full gap-y-4 xl:gap-y-0 mb-5">
          ...
          <div className="flex flex-row gap-2 sm:gap-4 w-auto">
            ...
            <Select
              defaultValue="dissemination-and-advocacy"
              onValueChange={(value) => {
        ...
        <div className="text-base p-6 xl:text-lg xl:p-12 w-full bg-white text-black border border-black/5 shadow-2xl rounded-lg">
          <div className="flex flex-col gap-2">
            <div className="grid grid-cols-[1.5rem_auto] gap-x-5 text-2xl xl:text-4xl font-bold">
              ...
              <p>Dissemination and Advocacy</p>
            </div>
            ...
            <div className="py-6 flex flex-col gap-6">
              ...
              <div>
                ...
                <p>Show how findings will be shared and used.</p>
              </div>
              ...
              <div>
                ...
                <ul className="list-disc list-inside ml-4 space-y-1">
                  <li>Presenting findings at the school research congress.</li>
                  <li>
                    Sharing the results with teachers through regular meetings.
                  </li>
                  <li>
                    Providing policy input to school administrators based on
                    findings.
                  </li>
                </ul>
              </div>
