      ...
      <div className="flex flex-col py-24 xl:py-32 relative gap-2 justify-center items-start w-full text-black px-5 xl:px-10">
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>III. Acknowledgment</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
        ...
        <div className="flex flex-col md:flex-row justify-between items-start xl:items-center w-full gap-y-4 xl:gap-y-0 mb-5">
          ...
          <div className="flex flex-row gap-2 sm:gap-4 w-auto">
            ...
            <Link href="/teacher-guide/basic/full-paper/introduction-and-rationale">
              <Button
                variant="default"
                className="w-[100px] bg-white hover:bg-black/10 border border-black/5 rounded-lg transition-all duration-300 cursor-pointer"
              >
        ...
        <div className="text-base p-6 xl:text-lg xl:p-12 w-full bg-white text-black border border-black/5 shadow-2xl rounded-lg">
          <div className="flex flex-col gap-2">
            ...
            <div className="py-6 flex flex-col gap-2">
              ...
              <p>
                Express gratitude to individuals or groups who contributed to
                the research.
              </p>
              ...
              <ul className="list-disc list-inside ml-4 space-y-1">
                <li>
                  Acknowledge your adviser, respondents, school heads, family,
                  and peers.
                </li>
              ...
              <p>
                ...
                adviser, Mr. Jose R. Reyes, for his unwavering support,
                guidance, and valuable insights throughout this research
                process. I also extend my heartfelt thanks to all the students
                who participated in this study, the school heads for their
                cooperation, and my family for their continuous encouragement.
                Finally, I would like to acknowledge my peers for their constant
