          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="py-6 flex flex-col gap-6">
              ...
              <div>
                ...
                <p>A summary of the entire study in 150–250 words.</p>
              </div>
              ...
              <div>
                ...
                <ul className="list-disc list-inside ml-4 space-y-1">
                  <li>
                    <span className="font-bold">Context/Background</span> (1–2
                    sentences)
                  </li>
                  <li>
                    <span className="font-bold">Objective</span> (1 sentence)
                  </li>
                  <li>
                    <span className="font-bold">Methodology</span> (2–3
                    sentences: design, population, instrument, analysis)
                  </li>
                  <li>
                    <span className="font-bold">Results</span> (main findings in
                    brief)
                  </li>
                  <li>
                    <span className="font-bold">Conclusion/Recommendation</span>{" "}
                    (1 sentence)
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <p>
                  This study examined the relationship between students’ study
                  habits and academic performance in selected public high
                  schools in Cavite. Using a descriptive-correlational design, a
                  structured questionnaire was administered to 150 Grade 10
                  students from Imus and Bacoor. Statistical analysis showed a
                  significant positive correlation between regular study habits
                  and academic performance. Findings suggest the need for school
                  programs that strengthen students' study discipline and time
                  management.
                </p>
              </div>
            </div>
