      ...
      <div className="flex flex-col py-24 xl:py-32 relative gap-2 justify-center items-start w-full text-black px-5 xl:px-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start xl:items-center w-full gap-y-4 xl:gap-y-0 mb-5">
          ...
          <div className="flex flex-row gap-2 sm:gap-4 w-auto">
            <Link href="/student-guide/quantitative-research/abstract">
              <Button
                variant="default"
        ...
        <div className="text-base p-6 xl:text-lg xl:p-12 w-full bg-white text-black border border-black/5 shadow-2xl rounded-lg">
          <div className="flex flex-col gap-2">
            ...
            <div className="py-6 flex flex-col gap-6">
              <p>
                Thank those who contributed to the completion of your research:
              </p>
              <ul className="list-disc list-inside ml-4 space-y-1">
                <li>Adviser, panelists</li>
                <li>School principals and respondents</li>
                <li>Parents, peers, or sponsors</li>
              </ul>
            </div>
          </div>
        </div>
