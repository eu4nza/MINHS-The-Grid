      ...
      <div className="flex flex-col py-24 xl:py-32 relative gap-2 justify-center items-start w-full text-black px-5 xl:px-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start xl:items-center w-full gap-y-4 xl:gap-y-0 mb-5">
          ...
          <div className="flex flex-row gap-2 sm:gap-4 w-auto">
            <Link href="/student-guide/quantitative-research/problem-and-background">
              <Button
                variant="default"
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="py-6 flex flex-col gap-6">
              ...
              >
                ...
                <p>
                  Discuss relevant books, theories, and academic writings.
                  <br /> Use a mix of international and local literature (e.g.,
                  time management theories, learning strategies).
                </p>
              </section>
              ...
              >
                ...
                <p>
                  Summarize past research that used quantitative designs and are
                  similar in topic. <br /> Prior local studies from Cavite,
                  CALABARZON, or DepEd are highly relevant.
                </p>
              </section>
              ...
              >
                ...
                <p>Combine the ideas to show:</p>
                <ul className="list-disc list-inside ml-4 space-y-1">
                  <li className="font-bold">What is already known</li>
                  <li className="font-bold">What is lacking</li>
                  <li className="font-bold">
                    How your study will fill the gap
                  </li>
                </ul>
              </section>
            </div>
