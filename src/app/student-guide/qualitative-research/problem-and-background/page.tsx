          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="py-6 flex flex-col gap-6">
              ...
              >
                ...
                <p>
                  Provide a general overview of the topic and its relevance.
                  Start with the broader issue (e.g., digital learning
                  post-pandemic) then narrow down to Cavite schools.
                </p>
              </section>
              ...
              >
                ...
                <p>
                  Provide detailed context for your research. Include
                  Cavite-specific data, education policies (e.g., DepEd
                  CALABARZON reports), or trends in blended learning.
                </p>
              </section>
              ...
              >
                ...
                <p>
                  Clearly state your main research question and sub-questions.
                </p>
                <p>
                  <span className="font-bold">Main Problem:</span>
                  <br />
                  What are the experiences of public high school teachers in
                  Cavite in implementing blended learning using digital tools?
                </p>
                <p>
                  <span className="font-bold">Sub-questions:</span>
                </p>
                <ul className="list-disc list-inside ml-4 space-y-1">
                  <li>What challenges do they face?</li>
                  <li>What strategies have they developed?</li>
                  <li>What support systems are available?</li>
                </ul>
              </section>

              <hr className="border-t border-gray-300" />

              {/* Section D - Scope and Delimitation */}
              <section
              ...
              >
                ...
                <p>
                  Define what the study covers and does not cover. Focus on a
                  limited population (e.g., public high schools in Cavite) and
                  explain why.
                </p>
              </section>
              ...
              {/* Section E - Significance of the Study */}
              <section
              ...
              >
                ...
                <p>
                  Explain the value of your research. Who benefits: teachers,
                  DepEd, students, policymakers.
                </p>
              </section>

              <hr className="border-t border-gray-300" />

              {/* Section F - Definition of Terms */}
              <section
                id="definition-of-terms"
                className="transition-colors duration-500 py-5 px-5"
              >
                <p className="text-xl font-bold">🔹 f. Definition of Terms</p>
                <p>Clarify key concepts used in your study.</p>
                <ul className="list-disc list-inside ml-4 space-y-1">
                  <li>
                    <span className="font-bold">Blended Learning</span>- A mix
                    of face-to-face and online education.
                  </li>
                  <li>
                    <span className="font-bold">Digital Tools</span> - Devices
                    or platforms like Google Classroom, Zoom, or DepEd Commons.
                  </li>
                </ul>
              </section>
            </div>
