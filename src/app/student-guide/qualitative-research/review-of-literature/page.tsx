      ...
      <div className="flex flex-col py-24 xl:py-32 relative gap-2 justify-center items-start w-full text-black px-5 xl:px-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start xl:items-center w-full gap-y-4 xl:gap-y-0 mb-5">
          ...
          <div className="flex flex-row gap-2 sm:gap-4 w-auto">
            <Link href="/student-guide/qualitative-research/problem-and-background">
              <Button
                variant="default"
            ...
            <Select
              defaultValue="review-of-literature"
              onValueChange={(value) => {
        ...
        <div className="text-base p-6 xl:text-lg xl:p-12 w-full bg-white text-black border border-black/5 shadow-2xl rounded-lg">
          <div className="flex flex-col gap-2">
            <div className="grid grid-cols-[2rem_auto] gap-x-5 text-2xl xl:text-4xl font-bold">
              ...
              <p>Chapter II: Review of Related Literature and Studies</p>
            </div>

            <div className="py-6 flex flex-col gap-6">
              {/* Section A - Related Literature */}
              <section
                id="related-literature"
                className="transition-colors duration-500 py-5 px-5"
              >
                <p className="text-xl font-bold">🔹 a. Related Literature</p>
                <p>
                  Summarize books, articles, and policies related to your topic,
                  both local and international. Be sure to cover the broader
                  context and related theories or frameworks that inform your
                  study.
                </p>
              </section>
              ...
              <section
                ...
                className="transition-colors duration-500 py-5 px-5"
              >
                <p className="text-xl font-bold">🔹 b. Related Studies</p>
                <p>
                  Focus on previous research that is relevant to your study,
                  preferably qualitative and Philippine-based. Include studies
                  from universities like UP, Ateneo, PNU, or reports from DepEd,
                  among others.
                </p>
              </section>
              ...
              <section
                ...
                className="transition-colors duration-500 py-5 px-5"
              >
                <p className="text-xl font-bold">🔹 c. Synthesis</p>
                <p>
                  Summarize the patterns and gaps in the literature and studies
                  you’ve reviewed. Explain how your study connects with,
                  contributes to, or addresses these gaps.
                </p>
                <p className="font-bold pt-2">📝 Example:</p>
                <p>
                  While prior studies identified technical and training
                  barriers, few focused specifically on Cavite teachers’ lived
                  experiences during blended learning transitions.
                </p>
              </section>
            </div>
          </div>
