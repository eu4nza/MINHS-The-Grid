      ...
      <div className="flex flex-col py-24 xl:py-32 relative gap-2 justify-center items-start w-full text-black px-5 xl:px-10">
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>II. Acknowledgement</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
        ...
        <div className="flex flex-col md:flex-row justify-between items-start xl:items-center w-full gap-y-4 xl:gap-y-0 mb-5">
          ...
          <div className="flex flex-row gap-2 sm:gap-4 w-auto">
            <Link href="/student-guide/qualitative-research/abstract">
              <Button
                variant="default"
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="py-6 flex flex-col gap-6">
              ...
              <div>
                ...
                <p>To thank people and institutions who helped you.</p>
              </div>
              ...
              <div>
                ...
                <p>
                  The researchers extend their deepest gratitude to the
                  Department of Education Cavite Division, school principals,
                  and teachers who generously shared their time and insights.
                  Special thanks to our adviser, Dr. ____, for her valuable
                  guidance.
                </p>
              </div>
            </div>
